...
SECRET_KEY = 'fi!l1*)t==&it0+#j$658942vs3ln&=rm*1r4bwy8-9^%ytxvk'
...
INSTALLED_APPS = [
    'crispy_forms',
    'laboratory_app.apps.LaboratoryAppConfig',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'HealthInhand.0@gmail.com'
EMAIL_HOST_PASSWORD ='HealthInhand@123'